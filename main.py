...
# Initialize free third-party API configurations safely
...
# Define clean incoming data definitions (Data Schemas)
...
def handle_site_engineer_service(data: TicketInput):
    try:
        # Prompt telling AI to act as a diagnostic assistant
        system_prompt = (
        ...
        completion = groq_client.chat.completions.create(
            ...
            model="llama3-8b-8192",  # Fast model optimized for free tiers
            temperature=0.1
        )
        ai_tip = completion.choices.message.content

        # Save to your free Supabase database automatically
        db_record = {
